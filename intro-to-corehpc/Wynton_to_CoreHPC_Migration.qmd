...
## Partitions + limits {.small-bullets}
...
## GPU request syntax {.small-bullets}
...
-   UCSF docs (translate bastion/login/partition names to Gladstone-side):
    -   CoreHPC Access Primer
    -   CoreHPC FAQ
    -   CoreHPC Miniforge Conda Guide
    -   SGE to SLURM translation guide

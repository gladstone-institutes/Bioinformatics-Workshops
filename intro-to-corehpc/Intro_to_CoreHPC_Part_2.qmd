...
-   `srun` runs the command as a tracked **job step**, which `sacct` reports on its own line
-   It is also what launches your command on **every node** you asked for, if you request more than one

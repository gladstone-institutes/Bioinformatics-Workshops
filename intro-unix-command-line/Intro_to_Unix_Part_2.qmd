...
#| echo: false
#| output: false
curl -o part_2/homo_sapiens.refseq.tsv.gz https://ftp.ensembl.org/pub/release-116/tsv/homo_sapiens/Homo_sapiens.GRCh38.116.refseq.tsv.gz
```
...
- The uncompressed file is 43 megabytes
...
September 10-September 11, 2026 1:00-3:00pm PDT  

...
Agentic coding amplifies whatever habits you already have, good and bad. The more the model does, the more these practices pay off:  
...
- **Human review**: You're still the author, the model's output is a draft until you've read it 

These practices aren't new, but agentic coding raises the payoff for having them in place.
...
Creating with AI carries risks that are easy to overlook until they bite:
...
- **Copyright and IP**: AI-generated text can reproduce IP without citation
- **Methodological choices**: AI will confidently suggest statistical methods or parameters that don't fit your data
...
- [Budzyń et al. (2025), *Lancet Gastroenterol Hepatol*](https://doi.org/10.1016/S2468-1253(25)00133-5): endoscopists showed a 20% relative drop in adenoma detection rate on non-AI colonoscopy after routine AI exposure.
- [Turney et al. (2026), *Adv Med Educ Pract*](https://doi.org/10.2147/AMEP.S583763): AI in medical training improves efficiency and basic knowledge, but higher-order clinical reasoning outcomes are mixed or weaker.
- [Lee et al. (2025), *CHI '25*](https://doi.org/10.1145/3706598.3713778): survey of 319 knowledge workers: higher confidence in AI predicts less critical thinking; higher self-confidence predicts more.
...
## Taking Responsibility for AI Output
...
- **Manuscripts**: Most journals require disclosure in Methods, Acknowledgments, or Author Contributions. AI cannot be an author, and many journals prohibit AI-generated figures
- **Grant proposals**: AI use is generally discouraged; check funder guidelines (NIH, NSF) before submitting AI-assisted text
- **Collaborators and supervisors**: When AI shaped the analysis or writing, let your team know

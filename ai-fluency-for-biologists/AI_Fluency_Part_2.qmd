...
## Common AI Errors in Science {.small-bullets}
...
![](assets/verification_workflow.svg){fig-alt="Five-step verification workflow shown as a horizontal pipeline: 1. Compare to source, 2. Verify claims, 3. Check citations, 4. Validate data, 5. Assess quality, with the reminder to make this a habit for every AI output" .nostretch fig-align="center" width=95%}
...
## Exercise: Research Mode -- Discernment {.small_custom}
...
:::{.example}
"Summarize the current state of research on [your topic], focusing on key findings from the last 2 years. Include any ongoing debates or unresolved questions in the field."
:::
...
## Exercise: Review Your Research Mode Output {.small_custom}
...
![](assets/deployment_diligence.svg){fig-alt="Five-step deployment diligence process shown as a horizontal pipeline: 1. Generate (AI produces a draft), 2. Verify (check against sources), 3. Edit (revise for accuracy), 4. Review (would you sign off?), 5. Document (note AI's role), with the principle that you vouch for everything you submit" .nostretch fig-align="center" width=95%}
...
## Journal AI Policies {.small}

Most major journals now have AI use policies. Common themes:

- **Disclosure required** -- Authors must declare AI-assisted writing or analysis (Nature, Science, PNAS, Cell)
...
**Task:** Create a 150-200 word summary of the provided paper's main findings for a literature review.

Apply the techniques from today:

- **Provide context** -- Tell the AI about your field and purpose
- **Specify constraints** -- Set the word count, audience, and structure
- **Break into steps** -- If helpful, give the AI a sequence to follow
- **Define a role** -- Set the AI's expertise level

## Exercise Steps

1. **Draft your prompt** using at least 3 techniques (3 min)
2. **Run it through Claude** and review the output (2 min)
3. **Evaluate the output** against the original paper -- is it accurate and complete? (3 min)
4. **Reflect:** Which techniques helped most? What would you change next time? (2 min)

*Tip: If the first output isn't right, iterate! Refine your prompt and try again.*

## Share Your Results

**2-3 volunteers:** Share your prompt and the AI's output with the group.

Discussion points:

- Which techniques did you use?
- How close was the output to what you wanted?
...
- Strategies for incorporating AI into your existing workflow
...
AI is a powerful tool for research -- but **you** remain the scientist
...
- **UCSF AI Guidelines** -- Check your institution's policies on AI use in research
- **Journal Policies** -- Always check your target journal's current author guidelines

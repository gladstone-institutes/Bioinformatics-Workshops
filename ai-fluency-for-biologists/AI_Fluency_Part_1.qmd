...
## Visual Reasoning: A Good Task

You can upload images and AI will describe, interpret, or extract information from them

- Photos of gels, plates, blots, or microscopy
- Figures from papers ("explain this figure")
- Handwritten notes or whiteboard diagrams
- Error messages and screenshots
- Tables in PDFs ("extract this data")

AI can misread details in images just like text — always verify
...
Acceptable: conceptual diagrams and presentation graphics (with disclosure)

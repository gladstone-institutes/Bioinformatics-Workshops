...
Most machine learning algorithms cannot handle missing values. We need to either:
...
Some algorithms (like K-means clustering) are sensitive to the scale of features.
...
If temperature ranges from 36-40 and symptoms are 0-1, temperature will dominate distance calculations in algorithms like K-means!
...
- **Part 2:** Apply Random Forest for classification
- **Part 3:** Apply K-means for clustering

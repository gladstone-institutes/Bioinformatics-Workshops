...
![](assets/R_and_RStudio.png){fig-alt="Analogy showing RStudio as a car body and R as the engine that powers it" .nostretch fig-align="center" width=65%}


## Layout

![](assets/RStudio_layout.png){fig-alt="RStudio interface with four labeled panes: Editor (top-left), Environment/History (top-right), Console (bottom-left), and Output for files, plots, packages, and help (bottom-right)" .nostretch fig-align="center" width=95%}
...
![](assets/data structures.png){fig-alt="Diagram showing four R data structures: a vector as a single row, a list containing mixed elements, a matrix as a uniform grid, and a data frame as a grid with columns of different types shown in different colors" .nostretch fig-align="center" width=95%}
...
![](assets/functions.png){fig-alt="Annotated R function call showing mean(x = c(1,2,3), na.rm = FALSE) with arrows pointing to the function name and its arguments" .nostretch fig-align="center" width=70%}
...
August 17 - August 18, 2026 1:00pm - 3:00pm PDT  

**Introduction to Unix Command Line**  
August 24 - August 25, 2026 1:00pm - 3:00pm PDT  

**Introduction to Core HPC**  
September 10 - September 11, 2026 1:00pm - 3:00pm PDT  

**Introduction to Machine Learning**  
September 24, 2026 1:00pm - 5:00pm PDT  

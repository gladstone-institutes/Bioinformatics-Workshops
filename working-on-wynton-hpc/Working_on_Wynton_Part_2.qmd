...
## Notes on Using AI on Wynton {.smaller}

- AI tools (ChatGPT, Claude, Gemini) can help write and debug job scripts, troubleshoot errors, and explain cluster concepts
- Wynton storage is not backed up. Make sure you understand what any AI-generated script does before running it, especially if it moves or deletes files
- When using AI to write scripts that run on development nodes, give it context about the resources available to you so it does not overload the shared nodes

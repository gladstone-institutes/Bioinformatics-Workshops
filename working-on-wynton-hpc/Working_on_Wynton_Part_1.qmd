...
-   Wynton is in the process of transitioning to and integrating with CoreHPC
    - Scheduled to conclude in spring 2027
-   CoreHPC will use the SLURM job scheduler system
-   This is the last time we will be teaching this workshop
